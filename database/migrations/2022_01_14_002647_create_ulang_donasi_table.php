...
class CreateUlangDonasiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ulang_donasi', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('keterangan_donatur', 100);
    ...
    {
        Schema::dropIfExists('ulang_donasi');
    }
}
